...
Я начал с стандартного сканирования `nmap`:
...
- Запуск FTP на порту 21
	- Допускается анонимный вход
- Запуск вебсервера на порту 80
	- IIS 7.5

### Все порты

Я подождал секунду, чтобы убедиться, что компьютер не блокирует ping-запросы, а затем запустил сканирование всех портов после завершения основного сканирования:
