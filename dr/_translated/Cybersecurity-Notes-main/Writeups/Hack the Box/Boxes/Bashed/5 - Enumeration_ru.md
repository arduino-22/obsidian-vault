...
Я провёл первоначальный сканирование `nmap`:
...
Это показывает только веб-сервер с названием «Arrexel's Development Site» — он доступен для использования. Он работает Apache 2.4.18 на Ubuntu.

### Полный сканирование портов

Поскольку стандартный сканирование nmap завершилось очень быстро, я отказался от обычного `sleep 300` и просто выполнил полный сканирование портов:
...
Это не выявило ничего нового.

### Сканирование UDP

Я также выполнил сканирование UDP, что обычно не делаю, но поскольку открыт только один порт, я решил проверить. Сканирование UDP требует root-права:
...
На UDP не было ничего работающего.

## Gobuster

После обнаружения сайта я выполнил gobuster:
...
/.phtml               (Status: 403) [Size: 291]                                 
/.php                 (Status: 403) [Size: 291]                                 
/.html-               (Status: 403) [Size: 291]                                 
/.html.LCK            (Status: 403) [Size: 291]                                 
/.html.LCK             (Status: 403) [Size: 291]                                 
/.html.LCK            (Status: 403) [Size: 291]                                 
/.html.LCK            (Status: 403) [Size: 291]                                 
/.html.LCK            (Status: 403) [Size: 291]                                 
